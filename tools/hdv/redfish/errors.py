...
ERROR_CODE = {
    ...
    "E200001": "E200001:unsupported input file_mode, should be one of [yaml,excel]",
    # E300XXX: resource issue  - depended resource is not existing...
    "E300001": "E300001:invalid token",
    "E300002": "E300002:fail to get dependency parent id, Action: check if the resource support by server",
    "E300003": "E300003:fail to get expected id list for component_id, Action: check if the resource support by server",
    ...
    "E400006": "E400006: unexpected expected value type, expected[str,list,dict]",
    "E400007": "E400007: unexpected expected value type while comparing",
    # E500XXX: application - find no value from cache
    "E500001": "E500001: fail find key from actual value, Action: check if the attribute support by server",
    # E600XXX: restful interface
    "E600001": "E600001: unsupported redfish api?",
    }

WARN_CODE = {
    "W100001":"fail to the response from a request",
    "W100002": "unexpected type of return_value type",
    "W100003": "NoneType value",
}
