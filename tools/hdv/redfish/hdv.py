...
hdv tools
 ...
 - excel: tools will parse the depend_id sheet and cases sheet and execute test case and write report back to excel
 - yaml: tools will parse depends.yaml and cases.yaml and execute test case and write a report.yaml
 theory:
...
def parse_args():
    ...
    parse arguments
    '''
    parser = argparse.ArgumentParser(description="hdv tool by redfish, check readme under ./docs")
    ...
    parser.add_argument('--depends_yaml', type=str, default="./conf/depends.yaml",\
...
def main():
    ...
    '''
    args = parse_args()
    run_case(args.config, args.case_excel, args.depends_yaml, args.case_yaml, args.file_type)
